...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserIP'
        db.create_table(u'rating_userip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15)),
        ))
        db.send_create_signal(u'rating', ['UserIP'])

        # Adding model 'Eintrage'
        db.create_table(u'rating_eintrage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'rating_userip')

        # Deleting model 'Eintrage'
        db.delete_table(u'rating_eintrage')
    ...
    models = {
        ...
        u'rating.eintrage': {
            'Meta': {'object_name': 'Eintrage'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rating.UserIP']", 'null': 'True', 'blank': 'True'}),
